...
PATH_TO_SEED_DOCS_TITLE_AND_PROCESSED_QUERY = proj_dir + \
    'train/seedDocs_title_and_processedQuery/'

PATH_TO_SEED_DOCS_TITLE_AND_PROCESSED_QUERY_AND_1_REL_DOC = proj_dir + \
    'train/seedDocs_title_and_processedQuery_rel_document/'
...
for topic in TOPIC_LIST:
    ...
    completeName1 = os.path.join(
        PATH_TO_SEED_DOCS_TITLE_AND_PROCESSED_QUERY, topic)
    ...
    completeName = os.path.join(
        PATH_TO_SEED_DOCS_TITLE_AND_PROCESSED_QUERY_AND_1_REL_DOC, topic)
