...
def evaluate_topic(X_train, y_train, X_test, classifier):
  ...
  if classifier == 'svm':
    ...
    #print(p)
    #print('temp_min_val: ', temp_min_val)
    #print('prediction: ', p)
    #print('new prediction: ', new_p)
    ...
    #print(y_test_predict_log_proba)
    ...
    #prob_per_class_dictionary = dict(zip(clf.classes_, y_test))
    #gets a list of ['most_probable_class', 'second_most_probable_class', ...., 'least_class']
    #results_ordered_by_probability = map(lambda x: x[0], sorted(zip(clf.classes_, y_test),  key=lambda x: x[1], reverse=True)) 
    #print('prob_per_class_dictionary: ', prob_per_class_dictionary)
    #print('results_ordered_by_probability: ', list(results_ordered_by_probability))
    ...
    # Also, it will be meaningless results on very small datasets.
