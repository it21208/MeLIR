...
#         self.assertFalse('Foo'.isupper())
    ...
    dicts_list = [run_test.tfidf_dict, run_test.docid_idx_dict, run_test.vocab_idx_dict]
    ...
    try:
        ...
        print(3-count_errors,' out of 3 cases from test case ',count_tests,'are okay.')
    except:
...
if __name__ == '__main__':
    ...
    else: print('Ran ', tests.count_tests, ' test cases in ', 
              time.time() - start_time, ' seconds.')
